"""Top-level visualization package.

Re-exports plot builders and export utilities from the experiment-level
visualization sub-package so that callers can use either
``from visualization import ...`` or
